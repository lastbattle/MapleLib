...
namespace MapleLib.PacketLib
{
	...
	public class PacketWriter : AbstractPacket, IDisposable
	{
        ...
        /// <summary>
        /// Creates a new instance of PacketWriter
        /// (DO NOT set this to public, messy code generated by AI by pre-defining packet size)
        /// </summary>
		...
		private PacketWriter(int size)
		{
			...
			_binWriter = new BinaryWriter(_buffer, _encoding);
		}
		...
		public PacketWriter(Stream stream, Encoding encoding, bool leaveOpen)
		{
			...
			_binWriter = new BinaryWriter(_buffer, _encoding, leaveOpen);
		}
